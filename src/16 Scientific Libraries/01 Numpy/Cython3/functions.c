...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_s_sumOfRoots);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_s_sumOfRoots);
...
#define __pyx_n_s_sumOfRoots __pyx_mstate_global->__pyx_n_s_sumOfRoots
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds) {
      ...
      if (unlikely(kw_args > 0)) {
        ...
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values + 0, kwd_pos_args, "sumOfRoots") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_n_s_sumOfRoots, __pyx_k_sumOfRoots, sizeof(__pyx_k_sumOfRoots), 0, 0, 1, 1},
