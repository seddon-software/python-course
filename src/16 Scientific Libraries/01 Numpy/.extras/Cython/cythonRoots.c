...
#define __pyx_kp_u_cythonRoots_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_cythonRoots __pyx_string_tab[5]
...
#define __pyx_n_u_sum __pyx_string_tab[18]
#define __pyx_n_u_sumOfRoots __pyx_string_tab[19]
#define __pyx_n_u_test __pyx_string_tab[20]
#define __pyx_n_u_values __pyx_string_tab[21]
#define __pyx_kp_b_iso88591_U_1_t1E_1 __pyx_string_tab[22]
...
static PyMethodDef __pyx_mdef_11cythonRoots_1sumOfRoots = {"sumOfRoots", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_11cythonRoots_1sumOfRoots, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_11cythonRoots_1sumOfRoots(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("sumOfRoots (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "sumOfRoots", 0) < (0)) __PYX_ERR(0, 6, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("sumOfRoots", 1, 1, 1, i); __PYX_ERR(0, 6, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("sumOfRoots", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L6_skip:;
...
static PyObject *__pyx_pf_11cythonRoots_sumOfRoots(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("sumOfRoots", 0);
...
*/
  ...
  __pyx_t_4 = PyFloat_FromDouble(__pyx_v_sum); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
...
__Pyx_RefNannySetupContext("PyInit_cythonRoots", 0);
 ...
 *     cdef double sum
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_11cythonRoots_1sumOfRoots, 0, __pyx_mstate_global->__pyx_n_u_sumOfRoots, NULL, __pyx_mstate_global->__pyx_n_u_cythonRoots, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_sumOfRoots, __pyx_t_2) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{15},{20},{18},{18},{11},{8},{1},{13},{5},{8},{10},{1},{8},{3},{12},{12},{10},{3},{10},{8},{6},{38}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (189 bytes) */
const char* const cstring = "x\332MN;\n\002A\014UP\021,\304#\354\005\204=\201\215\266*\202\365c\034\26388\237\325\311\310ng9\345\226\036\315cx\004\003\212\030\302\343\275<^\222\205n\371\024\374.\004\216\363\272m\200\255\300\266]\032\315XS\303;\252Tl\2756a\256\3035$6\236\242\266\2020\036|U\232\016J\237\377\326\000U\362\03200\021\277\214arb9%))\027\216\311\022 \302+'\244\0165pI\312~$\020\211\277\226\260\243|\221,\307\344\2447\325\367\016Sd\340\246l\242x\357\277F\275\341$\027\317\3018\017\363\276+\272\3629\236f\356\312n\365\230=d>\311\345\033&i^<";
    PyObject *data = __Pyx_DecompressString(cstring, 189, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (239 bytes) */
const char* const bytes = "?cythonRoots.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_tracebackcythonRoots__func__i_is_coroutineitems__main____module__n__name__pop__qualname____set_name__setdefaultsumsumOfRoots__test__values\200\001\360\006\000\005\013\210!\330\004\010\210\005\210U\220!\2201\330\010\017\210t\2201\220E\230\021\230!\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_n, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u_sum};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_cythonRoots_pyx, __pyx_mstate->__pyx_n_u_sumOfRoots, __pyx_mstate->__pyx_kp_b_iso88591_U_1_t1E_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
