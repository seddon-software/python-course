...
def enhanceImage(image, threshold1, threshold2):
    black = (image <= threshold1)
    grey = (image > threshold1) & (image <= threshold2)
    white = (image > threshold2) 
    image[ white ] = 255
    image[ grey ] = 127
    image[ black ] = 0
