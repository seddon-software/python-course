...
print(greeks("call", "",      stockPrice = 31.55, strikePrice = 22.75, timeUntilExpiry = 3.5, riskFreeInterestRate = 5.0, volativity = 50.0))
print(greeks("put",  "",      stockPrice = 31.55, strikePrice = 22.75, timeUntilExpiry = 3.5, riskFreeInterestRate = 5.0, volativity = 50.0))
