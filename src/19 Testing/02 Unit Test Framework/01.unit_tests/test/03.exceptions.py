...
def standardTests():
    ...
    suite.addTest(testPoint('testMoveFixtureBy5inXand2inYusingBuggyMethod'))
    suite.addTest(testPoint('testDistanceFromOriginIs5'))
    suite.addTest(testPoint('testDistanceFromOriginIs5usingBuggyMethod'))
    return suite

def exceptionTests():
    suite = unittest.TestSuite()
    suite.addTest(testPoint('test_ExceptionRaisedWhen_get_distance_IsCalledFor_distantPoint'))
    suite.addTest(testPoint('test_ExceptionRaisedWhen_get_distance_IsCalledInWithClauseFor_distantPoint'))        
    suite.addTest(testPoint('test_ExceptionRaisedWhen_get_distance_IsCalledFor_point'))
    return suite
