...
# This class is called by the class being tested, but we don't want to use 
# the real class because it may be unavailable, take too long to run in a unit
# test or have further dependencies that are not available.  So we mock out 
# the methods used:
class Shares:
